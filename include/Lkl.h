...
class Lkl : public TNamed
{
 public:
  ...
  virtual Double_t ComputeLklVsG(Double_t gInitWithUnits=0,Bool_t centerAtZero=kFALSE,Int_t npoints=100,Double_t glow=0,Double_t gupp=0,Bool_t isVerbose=kTRUE);
